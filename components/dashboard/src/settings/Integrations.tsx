        ...
        {diconnectModal && (
            <Modal visible={true} onClose={() => setDisconnectModal(undefined)}>
                ...
                <div className="border-t border-b border-gray-200 mt-2 -mx-6 px-6 py-4">
                    <p className="pb-4 text-gray-500 text-base">Are you sure you want to disconnect from the following provider?</p>

                    <div className="flex flex-col ml-2 rounded-xl p-3 bg-gray-100">
                ...
                <div className="flex justify-end mt-6">
                    <button className={"ml-2 border-red-900 bg-red-500 "} onClick={() => disconnect(diconnectModal.provider)}>Disconnect Provider</button>
                </div>
            </Modal>
        )}
    ...
    return (<div>
        ...
        {modal?.mode === "delete" && (
            <Modal visible={true} onClose={() => setModal(undefined)}>
                ...
                <div className="flex justify-end mt-6">
                    <button className={"ml-2 border-red-900 bg-red-500 "} onClick={() => deleteProvider(modal.provider)}>Remove Integration</button>
                </div>
            </Modal>
        )}
...
function GitIntegrationModal(props: ({
    ...
    const activate = async () => {
        ...
        try {
            ...
            // wait two seconds for the changes to be propagated
        ...
        <div className="space-y-4 border-t border-b border-gray-200 mt-2 -mx-6 px-6 py-4">
            {props.mode === "edit" && props.provider.status === "pending" && (
                <div className="flex rounded-md bg-gitpod-kumquat-light p-3">
                    <span className="text-red-600">You need to actiate this integration.</span>
                </div>
            )}
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="w-full relative">
                    <input name="redirectURL" disabled={true} readOnly={true} type="text" value={redirectURL} className="rounded-md w-full" />
